...
public class Main {
    ...
    private static Marker searchHistory;
    private static Marker errorsHistory;
    ...
    public static void main(String[] args) {
        ...
        searchHistory = MarkerManager.getMarker("search");
        errorsHistory = MarkerManager.getMarker("errors");
        ...
        for (; ; ) {
            try {
                ...
                logger.info(searchHistory, "Пользователь ввел маршрут от {} до {}", from,to);
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            logger.info(errorsHistory,"Станция не найдена : {}" + line);
